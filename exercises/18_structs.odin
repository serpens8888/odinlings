...
Point :: struct {
    x: int, /* this is a struct field, it has a name and a type
             ...
             * the types will be set to their zero value
             * ex: (int -> 0, string -> "", bool -> false, ^int -> nil)
            */
    y: int,
}
...
main :: proc() {
    ...
    /*
     * looking at those four points a,b,c and d are (x,y) pairs
     * and they make a square don't they?
     *
     *    b(0,10)      c(10,10)
     *     .__________.
     *     |          |
